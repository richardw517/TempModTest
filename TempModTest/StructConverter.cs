    ...
    public class StructConverter
    {
        ...
        public static object[] Unpack(string fmt, byte[] bytes)
        {
            ...
            foreach (char c in fmt.ToCharArray())
            {
                switch (c)
                {
                    case 'q':
                        buf = new byte[8];
                        Array.Copy(bytes, byteArrayPosition, buf, 0, 8);
                        if (endianFlip)
                        {
                            Array.Reverse(buf);
                        }
                        outputList.Add((object)(long)BitConverter.ToInt64(buf, 0));//(bytes, byteArrayPosition));
                        byteArrayPosition += 8;
                    ...
                    case 'Q':
                        ...
                        outputList.Add((object)(ulong)BitConverter.ToUInt64(buf, 0));// (bytes, byteArrayPosition));
                        byteArrayPosition += 8;
                        //Debug.WriteLine("  Added unsigned 64-bit integer.");
                        break;
                    case 'l':
                        buf = new byte[4];
                        Array.Copy(bytes, byteArrayPosition, buf, 0, 4);
                        if (endianFlip)
                        {
                            Array.Reverse(buf);
                        }
                        outputList.Add((object)(int)BitConverter.ToInt32(buf, 0));// (bytes, byteArrayPosition));
                        byteArrayPosition += 4;
                    ...
                    case 'L':
                        ...
                        outputList.Add((object)(uint)BitConverter.ToUInt32(buf, 0));// (bytes, byteArrayPosition));
                        byteArrayPosition += 4;
                    ...
                    case 'h':
                        ...
                        outputList.Add((object)(short)BitConverter.ToInt16(buf, 0));// (bytes, byteArrayPosition));
                        byteArrayPosition += 2;
                    ...
                    case 'H':
                        ...
                        outputList.Add((object)(ushort)BitConverter.ToUInt16(buf, 0));// (bytes, byteArrayPosition));
                        byteArrayPosition += 2;
        ...
        public static byte[] Pack(object[] items, bool LittleEndian, out string NeededFormatStringToRecover)
        {
            ...
            foreach (object o in items)
            {
                ...
                if (endianFlip == true) Array.Reverse(theseBytes);//theseBytes = (byte[])theseBytes.Reverse();
